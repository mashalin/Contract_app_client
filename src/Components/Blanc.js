            ...
            <Row>
                ...
                <Col md={6} >
                    ...
                    <p style={{fontSize: '20px', fontFamily: 'Roboto',  marginLeft: '2rem'}}>
                       При получении <span className="span">направления на обучение</span> необходимо заполнить и распечатать <span className="span">договор</span> о повышении квалификации руководящего работника (специалиста) за счет средств республиканского (местного) бюджета или <span className="span">договор</span> о повышении квалификации руководящего работника (специалиста) <span className="span">на платной основе</span>.
                    </p>
                </Col>
            </Row>
        </Container>
