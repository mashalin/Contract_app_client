...
import { Context } from "..";
import { deleteAllJournals } from "../http/JournalApi";

function DeleteJournalModal({ setVisible }) {
  ...
  function deleteAllCont() {
    deleteAllJournals(courseId).then((data) => {
  ...
  return (
    <div>
      <h3 style={{ textAlign: "center", marginTop: "2rem" }}>
        Чтобы удалить все записи с курса заполните поле и нажмите "Сохранить"
      </h3>
