...
const Course = observer( () => {
    ...
    useEffect( () => {
        fetchCourses(1,15).then(data => {
            course.setCourses(data.rows.sort((a, b) => a.number > b.number ? 1 : -1));
        ...
        <div  style={{marginBottom: '4rem'}} >
            ...
            <Container style={{marginTop: '7rem'}} >
                 ...
                 <MyModal visible={editt} setVisible={setEditt} > 
                        <EditCourseModal setCourseEdit={setCourseEdit} courseEdit={courseEdit} setVisible={setEditt} />
                 </MyModal>
                ...
                <div>
                    <Row>
                        ...
                        <Col md={2} >
                            <Button onClick={() => setModall(true)} style={{marginLeft: '2rem'}} variant='success' > Добавить курс </Button>
                        </Col>
                    </Row>
                </div>
                ...
                <div style={{marginTop: '4rem'}} className='coursHeader' >
                    <Row>
                        <Col md={1} lg={1} >№PK</Col>
                        <Col md={6} lg={6} style={{marginLeft: '0.5rem'}} >Название</Col>
                        <Col md={2} lg={1} style={{marginLeft: '-1.5rem'}} >Стоимость</Col>
                        <Col md={1} lg={2} style={{marginLeft: '1.5rem'}} >Даты</Col>
                        <Col md={1} lg={1} ></Col>
                        <Col md={1} lg={1}>
                ...
                {course.courses.map( cours =>
                   <div className='coursItem' key={cours.id} >
                       <Row>
                           ...
                           <Col md={1} >
                               <img onClick={() => editFunc(cours.id)} style={{height: '27px', cursor: 'pointer'}} src={edit} alt="" />
                           </Col>
                           <Col md={1} >
                               <img onClick={() => deleteC(cours.id)} style={{height: '30px', cursor: 'pointer'}} src={trash} alt="" />
                           </Col>
                       </Row>
                   </div> 
                    )}
